...
using TechCorp.ApiClient.Staging.Client;
using TechCorp.ApiClient.Staging.Model;
...
namespace TechCorp.ApiClient.Staging.Api
{
    ...
    /// </summary>
    public interface IMessagesGetApiResponse : TechCorp.ApiClient.Staging.Client.IApiResponse, IOk<List<Message>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IMessagesPostApiResponse : TechCorp.ApiClient.Staging.Client.IApiResponse, ICreated<TechCorp.ApiClient.Staging.Model.Message?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IUsersGetApiResponse : TechCorp.ApiClient.Staging.Client.IApiResponse, IOk<List<User>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IUsersIdGetApiResponse : TechCorp.ApiClient.Staging.Client.IApiResponse, IOk<TechCorp.ApiClient.Staging.Model.User?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IUsersIdPutApiResponse : TechCorp.ApiClient.Staging.Client.IApiResponse, IOk<TechCorp.ApiClient.Staging.Model.User?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IUsersPostApiResponse : TechCorp.ApiClient.Staging.Client.IApiResponse, ICreated<TechCorp.ApiClient.Staging.Model.User?>
    {
        /// <summary>
        /// Returns true if the response is 201 Created
        /// </summary>
    ...
    public sealed partial class DefaultApi : IDefaultApi
    {
        ...
        /// </summary>
        public partial class MessagesGetApiResponse : TechCorp.ApiClient.Staging.Client.ApiResponse, IMessagesGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class MessagesPostApiResponse : TechCorp.ApiClient.Staging.Client.ApiResponse, IMessagesPostApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public TechCorp.ApiClient.Staging.Model.Message? Created()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsCreated
                    ? System.Text.Json.JsonSerializer.Deserialize<TechCorp.ApiClient.Staging.Model.Message>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryCreated([NotNullWhen(true)]out TechCorp.ApiClient.Staging.Model.Message? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class UsersGetApiResponse : TechCorp.ApiClient.Staging.Client.ApiResponse, IUsersGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class UsersIdGetApiResponse : TechCorp.ApiClient.Staging.Client.ApiResponse, IUsersIdGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public TechCorp.ApiClient.Staging.Model.User? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<TechCorp.ApiClient.Staging.Model.User>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out TechCorp.ApiClient.Staging.Model.User? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class UsersIdPutApiResponse : TechCorp.ApiClient.Staging.Client.ApiResponse, IUsersIdPutApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class UsersPostApiResponse : TechCorp.ApiClient.Staging.Client.ApiResponse, IUsersPostApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public TechCorp.ApiClient.Staging.Model.User? Created()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsCreated
                    ? System.Text.Json.JsonSerializer.Deserialize<TechCorp.ApiClient.Staging.Model.User>(RawContent, _jsonSerializerOptions)
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryCreated([NotNullWhen(true)]out TechCorp.ApiClient.Staging.Model.User? result)
            {
                result = null;
