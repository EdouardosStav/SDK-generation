...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.TechcorpApiClientDev);
  }
}(this, function(expect, TechcorpApiClientDev) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new TechcorpApiClientDev.SendMessageRequest();
  });
  ...
  describe('SendMessageRequest', function() {
    it('should create an instance of SendMessageRequest', function() {
      ...
      //var instance = new TechcorpApiClientDev.SendMessageRequest();
      //expect(instance).to.be.a(TechcorpApiClientDev.SendMessageRequest);
    });
