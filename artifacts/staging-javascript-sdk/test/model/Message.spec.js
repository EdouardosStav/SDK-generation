...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TechcorpApiClientStaging.Message();
  });
  ...
  describe('Message', function() {
    it('should create an instance of Message', function() {
      ...
      //var instance = new TechcorpApiClientStaging.Message();
      //expect(instance).to.be.a(TechcorpApiClientStaging.Message);
    });
