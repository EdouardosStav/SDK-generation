...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.TechcorpApiClientProd);
  }
}(this, function(expect, TechcorpApiClientProd) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new TechcorpApiClientProd.SendMessageRequest();
  });
  ...
  describe('SendMessageRequest', function() {
    it('should create an instance of SendMessageRequest', function() {
      ...
      //var instance = new TechcorpApiClientProd.SendMessageRequest();
      //expect(instance).to.be.a(TechcorpApiClientProd.SendMessageRequest);
    });
