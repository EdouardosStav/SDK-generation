...
* <pre>
* var TechcorpApiClientStaging = require('index'); // See note below*.
* var xxxSvc = new TechcorpApiClientStaging.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new TechcorpApiClientStaging.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new TechcorpApiClientStaging.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new TechcorpApiClientStaging.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
