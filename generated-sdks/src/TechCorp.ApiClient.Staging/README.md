...
inputSpec: specs/api-spec.yaml
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{92192335-79B7-4953-B42B-340E2AE11526}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IMessagesGetApiResponse apiResponse = await api.MessagesGetAsync("todo");
            List<Message>? model = apiResponse.Ok();
        }
...
- appName: My API
- appVersion: 1.0.0
- appDescription: A simple API for testing SDK generation

## Build
This C# SDK is automatically generated by the [OpenAPI Generator](https://openapi-generator.tech) project.

- SDK version: 2.0.0-rc.20250709.1053
