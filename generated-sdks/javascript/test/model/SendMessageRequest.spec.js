...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.MyApiClient);
  }
}(this, function(expect, MyApiClient) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new MyApiClient.SendMessageRequest();
  });
  ...
  describe('SendMessageRequest', function() {
    it('should create an instance of SendMessageRequest', function() {
      ...
      //var instance = new MyApiClient.SendMessageRequest();
      //expect(instance).to.be.a(MyApiClient.SendMessageRequest);
    });
