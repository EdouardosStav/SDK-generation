...
* <pre>
* var MyApiClient = require('index'); // See note below*.
* var xxxSvc = new MyApiClient.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new MyApiClient.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new MyApiClient.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new MyApiClient.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
