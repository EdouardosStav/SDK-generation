...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TechcorpApiClientStaging.SendMessageRequest();
  });
  ...
  describe('SendMessageRequest', function() {
    it('should create an instance of SendMessageRequest', function() {
      ...
      //var instance = new TechcorpApiClientStaging.SendMessageRequest();
      //expect(instance).to.be.a(TechcorpApiClientStaging.SendMessageRequest);
    });
